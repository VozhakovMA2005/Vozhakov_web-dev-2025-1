...
app = Flask(__name__)
app.config['SECRET_KEY'] = os.environ.get('SECRET_KEY', 'lab4_secret_key_2026')
...
def edit_user(user_id):
    ...
    return render_template('edit.html', user=user, roles=roles, errors=errors, form_data=form_data)
